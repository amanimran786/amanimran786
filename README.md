...
| 🦠 **[AI Malware Detection](https://github.com/amanimran786/AI-Malware-Detection)** | AI-powered malware detection system using EMBER dataset and ML models to classify PE files | Python, Jupyter, LightGBM, Docker |
