...
# Hey there! 👋 I'm Aman Imran

### 🎓 B.S. Software Engineering — San José State University
...
- 🎓 Recent **B.S. Software Engineering** graduate from **San José State University**
- 🔬 Former **Software Engineering Mobile Developer Intern** at **Lawrence Livermore National Laboratory**
- 🔭 Currently building **OSINT WorldView** — a full-stack intelligence dashboard
- 🛡️ Passionate about **cybersecurity, AI/ML, and secure development**
...
|---------|-------------|------|
| 🌍 **[OSINT WorldView](https://github.com/amanimran786/osint-worldview)** | Full-stack intelligence dashboard for monitoring & analyzing open-source signals | Python, FastAPI, React, Docker, Celery |
| 🦠 **[AI Malware Detection](https://github.com/vuvic/AI-Malware-Detection)** | AI-powered malware detection system using EMBER dataset and ML models to classify PE files | Python, Jupyter, LightGBM, Docker |
| 🧩 **[PatternQuest](https://github.com/amanimran786/PatternQuest)** | SwiftUI iOS app with interactive DSA levels — pattern recognition, Two Sum, sliding window | Swift, SwiftUI, Xcode, CI/CD |
| 🛡️ **[Phishing Detector Extension](https://github.com/amanimran786/PhishingDetectorExtension)** | Browser extension that detects phishing emails using machine learning | Python, JavaScript, HTML, ML |
...
| 💻 **[Portfolio](https://github.com/amanimran786/aman-portfolio)** | Hacker-themed portfolio with security-first UI, deployed on Vercel | Next.js, TypeScript, Tailwind CSS |
...
![GitHub Stats](https://github-readme-stats.vercel.app/api?username=amanimran786&show_icons=true&theme=tokyonight&hide_border=true&count_private=true)

![Top Languages](https://github-readme-stats.vercel.app/api/top-langs/?username=amanimran786&layout=compact&theme=tokyonight&hide_border=true)

![GitHub Streak](https://github-readme-streak-stats.herokuapp.com/?user=amanimran786&theme=tokyonight&hide_border=true)
